...
namespace YuvaCep.Persistence.Migrations
{
    ...
    [Migration("20260106125245_AddGenericBadgeSystem")]
    partial class AddGenericBadgeSystem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YuvaCep.Domain.Entities.ActivityChart", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("YuvaCep.Domain.Entities.BadgeDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("YuvaCep.Domain.Entities.StudentChartEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<Guid>("ActivityChartId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ActivityChartId");

                    b.ToTable("StudentChartEntries");
                });
            ...
            modelBuilder.Entity("YuvaCep.Domain.Entities.StudentBadge", b =>
                {
                    b.HasOne("YuvaCep.Domain.Entities.BadgeDefinition", "BadgeDefinition")
                        .WithMany()
            ...
            modelBuilder.Entity("YuvaCep.Domain.Entities.StudentChartEntry", b =>
                {
                    b.HasOne("YuvaCep.Domain.Entities.ActivityChart", "ActivityChart")
                        .WithMany("Entries")
                        .HasForeignKey("ActivityChartId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ActivityChart");
                });
